...
--SAIDA
EXECUTE PRC_MOV_ESTOQUE ('S',1,1,'AB',20,SYSDATE);
EXECUTE PRC_MOV_ESTOQUE ('S',1,1,'CD',30,SYSDATE);
EXECUTE PRC_MOV_ESTOQUE ('S',1,2,'EF',20,SYSDATE);
EXECUTE PRC_MOV_ESTOQUE ('S',1,2,'GH',15,SYSDATE);
