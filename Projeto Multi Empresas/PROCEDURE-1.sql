...
CREATE OR REPLACE PROCEDURE PROC_COPIA_MAT (V_EMP_DE IN NUMBER,
 ...
 WHEN V_EXECPT_EMP_DE THEN
      DBMS_OUTPUT.PUT_LINE('ATEN  O! EMPRESA ORIGEM NAO EXISTE');
      
 WHEN V_EXECPT_EMP_PARA THEN
      DBMS_OUTPUT.PUT_LINE('ATEN  O! EMPRESA DESTINO NAO EXISTE');
      
 WHEN V_EXECPT_EMP_MAT_DE THEN
      DBMS_OUTPUT.PUT_LINE('ATEN  O! MATERIAL NAO EXISTE NA EMPRESA ORIGEM');
      
  WHEN V_EXECPT_EMP_MAT_PARA THEN
       --RAISE_APPLICATION_ERROR(-20999,'ATEN  O! MATERIAL JA EXISTE NA EMPRESA DESTINO', FALSE);
       DBMS_OUTPUT.PUT_LINE('ATEN  O! MATERIAL JA EXISTE NA EMPRESA DESTINO');
